    ...
    <main class="main-content" id="MainContent" role="main" tabindex="-1">
        <div id="shopify-section-template--15107347906612__product-grid"
           ...
           negative-margin">
                            ...
                            @foreach($mostselled as $mostselled)
                                <li class="grid__item">
                                    <span class="products">
                                        <div class="card-wrapper">
                                            <div class="card-img">
                                                <a href="/product/{{ $mostselled->id }}"
                                                   class="full-unstyled-link">
                                                    <span class="visually-hidden">{{ $mostselled->name }}</span>
                                                        ...
                                                        <div class="card__inner">
                                                            <div>
                                                                <div
                                                                    ...
                                                                    <?php
                                                                        $a = json_decode($mostselled->photos);
                                                                    foreach ($a as $fotos){
                                                                        $split = explode(".png",
                                                                            $fotos);
                                                                        ?>
                                            ...
                                            <div class="card-information">
                                                <div class="card-information__wrapper"><span class="card-information__text h5">
                                                    ...
                                                    <div class="price  price--on-sale ">
                                                        <dl>
                                                            <div class="price__regular">
                                                                <dt>
                                                                    <span
                                                                        class="visually-hidden visually-hidden--inline">{{ $mostselled->price }}</span>
                                                                </dt>
                                                                <dd>
                                                    ...
                                                    <?
                                                    if (isset($_COOKIE['tovar'][$mostselled->id])) {
                                                        ?>
                                                                            <button
                                                        ...
                                                        ?>
                                                                            <div onclick="changeText(this)">
                                                                                <button
                                                                                    onclick="incrementclicks('{{ $mostselled->id }}');"
                                                                                    class="product-form__submit button select-button"
                                                                                    type="button" button-wishlist=""
                                                                                    data-product-handle="{{ $mostselled->id }}">Savatchaga
                                                                                </button></div>
                                                                            <?
                                                    }
                                                        ?>
